...
• Introduction of guests Adam and Dax, developers of Open Code
• Overview of Open Code, an agent for terminal experience
...
• Agents' limitations: reliance on specific models and tool sets
...
• Discussion of different AI providers (Anthropic, Google, Open Net, Llama)
...
• System prompts and how they influence model behaviour
...
• Challenges with TUI's (Text-based User Interfaces) in Charm
