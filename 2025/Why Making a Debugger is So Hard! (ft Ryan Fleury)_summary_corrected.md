...
• Introductions of guests Siege, Casey, and Ryan Fleur (also known as "Fleur")
• Topic announcement: debugging
• Explanation of print-f debugging by guest Ryan Fleur
...
• The speaker mentions using print debugging due to bad debuggers
• Good debuggers can collect data faster than print debugging
• Ryan's RAD Debugger project aims to provide a viable debugging solution on Linux
...
• Windbag as a classic example of a debugger with too many features
...
• The project was inherited by Alan from Wan Chen in 2021.
...
• Questioning of Ryan's involvement with Noodle and his lack of discussion about it
• Explanation of Noodle adjacency (being familiar with or related to Noodle)
...
• Ryan asked Wash about one OS feature he'd like to have but doesn't
...
• Idea to replace current debugging process with a says call to transfer control to the debugger
...
• Similar issues exist with print debugging and profiling markup insertion
...
• Limitations arise when overwriting multibyte instructions
...
• Explanation of CPU behaviour regarding checking return address stacks when performing a "ret" instruction.
...
• Plans to drop Elixir and use print debugging after this project
• Ideas for future streams on debugging in various languages, including C, Odin, and other compiled languages
• The ability to debug using Reply or full debuggers in VM languages like Java and Python with PDB (or "Pub G")
• Mention of a game called Pub G and a desire to play it, with one person being hesitant
• Discussion of playing video games as team building for a podcast or stream
• Mention of PUBG (Player Unknown's Battlegrounds) and its similarity to startup environments
...
• Substack return address with "nine one" written in it
