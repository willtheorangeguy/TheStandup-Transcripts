# The Standup Transcripts — Documentation

This archive holds machine-generated transcripts and summaries for the Standup episodes, together with the pipeline that produces them. The pipeline runs as 5 numbered stages; `main.py` executes them in order.

```
TheStandup-Transcripts/
├── docs/
│   ├── README.md          this page
