# The Standup Transcripts — Pipeline
...
|---|---|---|---|
| 1 | `1_download.py` | This script uses yt-dlp to download audio, by year, from the The Standup podcast website playlist. | — |
...
| 3 | `3_transcriber.py` | This script transcribes audio files from The Standup podcast episodes using OpenAI's Whisper model. | `transcribed.log` |
