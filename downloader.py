...
The Standup Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "TheStandup-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "TheStandup-Transcripts"
...
if __name__ == "__main__":
    ...
    url = "https://github.com/willtheorangeguy/TheStandup-Transcripts/archive/refs/heads/main.zip"
